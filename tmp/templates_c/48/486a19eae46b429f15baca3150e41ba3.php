...
class __TwigTemplate_9854e990fbe3187bebd5cb7b5916a0a5 extends Template
{
    ...
    public function block_loginContent($context, array $blocks = [])
    {
        ...
        ";
        // line 6
        yield from         $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 6, "1447162502")->unwrap()->yield(CoreExtension::merge($context, ["title" => $this->env->getFilter('translate')->getCallable()("Login_LogIn")]));
        // line 74
        yield "    </div>
    <div class=\"contentForm resetForm\" style=\"display:none;\">
        ";
        // line 76
        yield from         $this->loadTemplate("@Login/login.twig", "@Login/login.twig", 76, "514092166")->unwrap()->yield(CoreExtension::merge($context, ["title" => $this->env->getFilter('translate')->getCallable()("Login_ChangeYourPassword")]));
        // line 131
        yield "    </div>
...
{% endblock %}", "@Login/login.twig", "/var/www/html/matomo/plugins/Login/templates/login.twig");
    }
}


/* @Login/login.twig */
class __TwigTemplate_9854e990fbe3187bebd5cb7b5916a0a5___1447162502 extends Template
{
    private $source;
    private $macros = [];
...
/* @Login/login.twig */
class __TwigTemplate_9854e990fbe3187bebd5cb7b5916a0a5___514092166 extends Template
{
    private $source;
    private $macros = [];
